...
namespace tcn::doc::TcnTextureSamplerOp {

PYDOC(TcnTextureSamplerOp, R"doc(
TCN Artekmed Dephtimagepthi operator.
)doc")

// PyTcnTextureSamplerOp Constructor
PYDOC(TcnTextureSamplerOp_python, R"doc(
...
}  // namespace holoscan::doc::TcnTextureSamplerOp
