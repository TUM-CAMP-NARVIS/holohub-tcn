...
namespace tcn::doc::TcnDepthImageTemporalFilterOp {

PYDOC(TcnDepthImageTemporalFilterOp, R"doc(
TCN Artekmed Dephtimagepthi operator.
)doc")

// PyTcnDepthImageTemporalFilterOp Constructor
PYDOC(TcnDepthImageTemporalFilterOp_python, R"doc(
...
}  // namespace holoscan::doc::TcnDepthImageTemporalFilterOp
